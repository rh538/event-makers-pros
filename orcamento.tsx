...
function OrcamentoPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    formData.append("services",chosen);
    ...
    try{
      ...
      setSent(true);
      setForm({name:"",email:"",phone:"",eventDate:"",location:"",attendees:"",message:""});
      setSelected([]);
    }catch{
      ...
      <main className="container-x py-16 md:py-24 max-w-5xl">
        ...
        {sent ? (
          <div className="border border-primary/40 bg-primary/5 p-8 md:p-12 text-center">
            ...
            <h2 className="font-display font-black text-2xl md:text-3xl mb-3">Pedido enviado com sucesso!</h2>
